...
import { getAllPosts, getPost, getTopics, getYears, publishedFilenames } from "../lib/posts.js";
...
test("archive helpers remain stable before and after the first post", () => {
  ...
  assert.deepEqual(publishedFilenames("/definitely/missing/content/published"), []);
});
